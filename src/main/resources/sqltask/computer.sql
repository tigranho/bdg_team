...
ALTER TABLE Laptop  ADD
    CONSTRAINT PK_Laptop PRIMARY KEY  NONCLUSTERED(code);

ALTER TABLE PC  ADD
    CONSTRAINT PK_PC PRIMARY KEY  NONCLUSTERED(code);

ALTER TABLE Product  ADD
    CONSTRAINT PK_Product PRIMARY KEY  NONCLUSTERED(model);

ALTER TABLE Printer  ADD
    CONSTRAINT PK_Printer PRIMARY KEY  NONCLUSTERED(code);

ALTER TABLE Laptop ADD
    CONSTRAINT FK_Laptop_Product FOREIGN KEY
        (model) REFERENCES Product (model);
