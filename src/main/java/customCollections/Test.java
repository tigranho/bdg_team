...
//        System.out.println(list2.size());
        ...
        newCustomLinkedList.add(1, "assss");
        System.out.println(newCustomLinkedList.size());

        System.out.println(newCustomLinkedList.get(0));
        System.out.println(newCustomLinkedList.get(1));
        System.out.println(newCustomLinkedList.get(2));

        System.out.println(newCustomLinkedList.remove(0));
