package jdbctaskusingjpaproviderhibernate.service;
...
public interface PassengerService {
    Passenger getById(long id) throws SQLException, DatabaseException, jdbctaskusingjpaproviderhibernate.exceptions.DatabaseException;
